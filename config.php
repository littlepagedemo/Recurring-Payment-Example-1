...
//'------------------------------------	
$PayPalReturnURL 		= $domain.'/paypal/recurring/order_success.php'; //Return URL after user sign in from Paypal
...
//' This is set to the value entered on the Integration Assistant 
//'------------------------------------	
$PayPalCancelURL 		= $domain.'/paypal/recurring/'; // Cancel URL if user clicks cancel
